...
oauth.register(
    name='gitea',
    api_base_url='http://gitea.localnet',
    #request_token_url='http://gitea.localnet/login/oauth/request_token',
    #access_token_url='http://gitea.localnet/login/oauth/access_token',
    authorize_url='http://gitea.localnet/login/oauth/authorize',
    # userinfo_endpoint='account/verify_credentials.json?include_email=true&skip_status=true',
    # userinfo_compliance_fix=normalize_twitter_userinfo,
    # fetch_token=lambda: session.get('token'),  # DON'T DO IT IN PRODUCTION
)
