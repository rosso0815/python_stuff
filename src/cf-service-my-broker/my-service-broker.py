...
big_plan = {
          "id": "big_0001",
          "name": "large",
          "description": "A large dedicated service",
          "free": False
        }
...
small_plan = {
          "id": "small_0001",
          "name": "small",
          "description": "A small shared service"
        }

# services
echo_service = {'id': 'echo_service', 'name': 'Echo Service',
  'description': 'Echo back the value received', 'bindable': True, 
  'plans': [big_plan]}

invert_service = {'id': 'invert_service', 'name': 'Invert Service', 
    'description': 'Invert the value received', 'bindable': True, 'plans': [small_plan]}
